...
// khi nhan search thi se hien ra nut Detail
document.querySelector(".btn__details").style.display = "none";
document.querySelector("container_result").style.display = "none";

document.querySelector(".btn__search").addEventListener("click", function(event) {
    document.querySelector(".btn__details").style.display = "block";
    document.querySelector(".container_result").style.display = "block";
});

//click Details ra chi tiet cac san bay trung gian
